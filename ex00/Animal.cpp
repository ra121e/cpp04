...
/*   Updated: 2025/05/21 20:15:48 by athonda          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "this is dammy function. index is " << i << " idea is " << idea << std::endl;
}

std::string	const &Animal::getIdeas(int i) const
{
	std::cout << "this is dammy function. index is " << i << std::endl;
	static std::string dammy = "this is dammy";
	return (dammy);
}